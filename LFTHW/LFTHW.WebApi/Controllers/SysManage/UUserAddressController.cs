    ...
    public class UUserAddressController : ApiController
        {
            ...
            [Route("add")]
            public void PostAdd(U_UserAddress uUserAddress)
            {
                _IU_UserAddressBLL.Add(uUserAddress);
            }

            [Route("update")]
            public void PostEdit(U_UserAddress uUserAddress)
            {
                _IU_UserAddressBLL.Update(uUserAddress, null);
            }

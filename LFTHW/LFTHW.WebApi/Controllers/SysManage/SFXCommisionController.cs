    ...
    public class SFXCommisionController : ApiController
        {
            ...
            [Route("add")]
            public void PostAdd(S_FXCommision sFXCommision)
            {
                _IS_FXCommisionBLL.Add(sFXCommision);
            }

            [Route("update")]
            public void PostEdit(S_FXCommision sFXCommision)
            {
                _IS_FXCommisionBLL.Update(sFXCommision, null);
            }

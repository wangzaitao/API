...
namespace LFTHW.WebApi.Controllers.SysManage
{
    ...
    public class SProvinceController : ApiController
    {
        ...
        [Route("add")]
        public S_Province PostAdd(S_Province sProvince)
        {
            return _IS_ProvinceBLL.Add(sProvince);
        }

        [Route("update")]
        public bool PostEdit(S_Province sProvince)
        {
            return _IS_ProvinceBLL.Update(sProvince, null);
        }

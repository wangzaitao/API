...
namespace LFTHW.WebApi.Controllers.SysManage
{
    ...
    public class UPUserCommentController : ApiController
    {
        ...
        [Route("add")]
        public UP_UserComment PostAdd(UP_UserComment upUserComment)
        {
            return _IUP_UserCommentBLL.Add(upUserComment);
        }

        [Route("update")]
        public bool PostEdit(UP_UserComment upUserComment)
        {
            return _IUP_UserCommentBLL.Update(upUserComment, null);
        }

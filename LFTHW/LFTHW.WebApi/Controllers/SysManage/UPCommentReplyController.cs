    ...
    public class UPCommentReplyController : ApiController
        {
            ...
            [Route("add")]
            public void PostAdd(UP_CommentReply upCommentReply)
            {
                _IUP_CommentReplyBLL.Add(upCommentReply);
            }

            [Route("update")]
            public void PostEdit(UP_CommentReply upCommentReply)
            {
                _IUP_CommentReplyBLL.Update(upCommentReply, null);
            }

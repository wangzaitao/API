...
namespace LFTHW.WebApi.Controllers.SysManage
{
    ...
    public class UUserAccountController : ApiController
    {
        ...
        [Route("add")]
        public U_UserAccount PostAdd(U_UserAccount uUserAccount)
        {
            return _IU_UserAccountBLL.Add(uUserAccount);
        }

        [Route("update")]
        public bool PostEdit(U_UserAccount uUserAccount)
        {
            return _IU_UserAccountBLL.Update(uUserAccount, null);
        }

    ...
    public class UPOrderDetailController : ApiController
        {
            ...
            [Route("add")]
            public void PostAdd(UP_OrderDetail upOrderDetail)
            {
                _IUP_OrderDetailBLL.Add(upOrderDetail);
            }

            [Route("update")]
            public void PostEdit(UP_OrderDetail upOrderDetail)
            {
                _IUP_OrderDetailBLL.Update(upOrderDetail, null);
            }

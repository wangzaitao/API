...
namespace LFTHW.WebApi.Controllers.SysManage
{
    ...
    public class UPUserConsumeController : ApiController
    {
        ...
        [Route("add")]
        public UP_UserConsume PostAdd(UP_UserConsume upUserConsume)
        {
            return _IUP_UserConsumeBLL.Add(upUserConsume);
        }

        [Route("update")]
        public bool PostEdit(UP_UserConsume upUserConsume)
        {
            return _IUP_UserConsumeBLL.Update(upUserConsume, null);
        }

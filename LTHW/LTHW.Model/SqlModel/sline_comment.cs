namespace LTHW.Model
{
    ...
    [Table("stourwebcms.sline_comment")]
    public partial class sline_comment
    {
        ...
        [StringLength(255)]
        public string vr_nickname { get; set; }

        [StringLength(255)]
        public string vr_headpic { get; set; }

        public int? vr_jifencomment { get; set; }

        public int? vr_grade { get; set; }
    }
}
